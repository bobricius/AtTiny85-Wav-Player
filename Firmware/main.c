...
/ 
/ 2014 - Peter Misenko - Bobricius - Slovakia
/ + multiple directories
/ + reset signal to change directory
/ + playback resume after power on
/ + voice navigation and messages
/ + repeat and only one file file play for evry directory
/
/ you can buy working player https://www.tindie.com/stores/bobricius/
/
/----------------------------------------------------------------------------*/
...
BYTE PLAYMOD;       /* PLAY mode 0 normal 1 repeat loop 2 only one file */
